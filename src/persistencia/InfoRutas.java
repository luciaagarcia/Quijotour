...
public class InfoRutas {
	public ArrayList<ConstRuta> getRutas() {
		...
		rutas.add(new ConstRuta("Cabañeros", "120", "22", "Lucia A.", "ES", "10", "4",
				...
				"Montaña", true));
		rutas.add(new ConstRuta("Ciudad Real", "300", "7", "Sergio G.", "ES", "25", "1",
				"Habrá que parar a comer en el restaurante La Josefina", "Monumentos", false));
		rutas.add(new ConstRuta("Villanueva de los Infantes", "240", "5", "Manolito R.", "EN", "15", "2",
				...
				"Monumentos", false));
		rutas.add(new ConstRuta("Almadén", "150", "22", "Lucia A.", "ES", "30", "4",
