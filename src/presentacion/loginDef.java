...
public class loginDef extends JFrame {
	...
	public loginDef() {
		...
		gbl_panel_1.rowHeights = new int[]{301, 68, 63, 68, 61, 0, 0};
		...
		ImageIcon ic = new ImageIcon(
				new ImageIcon(loginDef.class.getResource("/presentacion/recursos/pngocean.com(1).png")).getImage().getScaledInstance(150,150,Image.SCALE_SMOOTH));
		...
		gbc_lblBienvenidosAQuijotour.gridy = 0;
